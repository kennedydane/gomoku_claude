...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('game_type', models.CharField(choices=[('GOMOKU', 'Gomoku'), ('GO', 'Go')], help_text='Type of game this ruleset is for', max_length=10)),
                ...
                ('komi', models.FloatField(default=6.5, help_text="Points given to white player to compensate for black's first move advantage (Go only)")),
                ('handicap_stones', models.PositiveIntegerField(default=0, help_text='Number of handicap stones for weaker player (Go only)', validators=[django.core.validators.MaxValueValidator(9)])),
                ('scoring_method', models.CharField(choices=[('TERRITORY', 'Territory'), ('AREA', 'Area')], default='TERRITORY', help_text='Method used for scoring (Go only)', max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
