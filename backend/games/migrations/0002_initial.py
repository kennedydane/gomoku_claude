...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='gamemove',
            constraint=models.UniqueConstraint(condition=models.Q(('col__gte', 0), ('row__gte', 0)), fields=('game', 'row', 'col'), name='unique_game_position', violation_error_message='This position is already occupied in this game'),
        ),
